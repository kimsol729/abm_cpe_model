...
ICUwashrate = [0.8,0.9,0.95,0.99]
variable_params = {"icu_hcw_wash_rate" : ICUwashrate}
# %% STEP4
model = CPE_Model(
...
data_mean = run_data.groupby(["icu_hcw_wash_rate"])['HCW_related_infecs'].mean()
print(data_mean)
print('\n\n')
...
csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..',
    'result/[{}.{}.{}]handwash_50.csv'.format(year,month,day))
