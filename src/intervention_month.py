...
np.random.seed(4321)
samples = np.random.choice(df["x"], 100, replace=True) # of Samples = 50
...
for i in variable_value:
    ...
    csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..',
        'result/intervention_test_wash2_{}.csv'.format(i))
...
for i in variable_value:
    ...
    csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..',
        'result/intervention_test_clean2_{}.csv'.format(i))
    run_data.to_csv(csv_path)
...
for i in variable_value:
    ...
    csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..',
        'result/intervention_test_iso2_{}.csv'.format(i))
    run_data.to_csv(csv_path)
...
for i in variable_value:
    ...
    csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..',
        'result/intervention_test_wash2B_{}.csv'.format(i))
    run_data.to_csv(csv_path)
...
for i in variable_value:
    ...
    csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..',
        'result/intervention_test_clean2B{}.csv'.format(i))
    run_data.to_csv(csv_path)
...
for i in variable_value:
    ...
    csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..',
        'result/intervention_test_iso2B_{}.csv'.format(i))
    run_data.to_csv(csv_path)
