...
from plot_distribution import dist_2v
...
# %%
var_comb = ['clean', 'wash'] # clean, wash or isol
# var_comb = ['clean', 'isol']
# var_comb = ['wash', 'isol']
...
if var_comb[0] == 'clean':
    ...
    title = dict(sub_1 = 'Hand Wash Rate 80%', sub_2 = 'Hand Wash Rate 90%',
                ...
                main = "HCW Wash Rate")
elif var_comb[0] == 'isol':
    variable_name = 'isolation_time'
    variable_value = [3, 7, 10, 14]
    title = dict(sub_1 = 'In 3 Days', sub_2 = 'In 7 Days',
