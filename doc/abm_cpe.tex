...
\begin{frame}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.5\textwidth]{../result/calibration/pic/[2022.8.17]CalibrateBeta4.eps.png} %must add a space here
...
\begin{frame}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.5\textwidth]{../result/calibration/pic/[2022.8.17]CalibrateBeta4_zoom.eps.png} %must add a space here
        \caption{Cummulative Average number of sick patients}
    \end{figure}
